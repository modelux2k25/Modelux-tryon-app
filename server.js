    ...
    try {
      ...
      **OPERATIONAL RULES (READ CAREFULLY):**
      ...
      1. **THE "NO CREATIVITY" RULE**:
         ...
         - If the product has 5 buttons, the output MUST have 5 buttons. Count them.
      
      2. **TEXTURE PRESERVATION (PRIORITY #1)**:
      ...
      3. **SLOW DOWN AND ANALYZE**:
         - Before generating, perform a pixel-level analysis of the Product Image.
         - Map the texture coordinates precisely to the user's body mesh.
         - Prioritize ACCURACY over speed. Take the necessary processing steps to ensure perfection.
