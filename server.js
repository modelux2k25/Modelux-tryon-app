...
const generateVirtualTryOn = async (userImageBuffer, userMimeType, productImageUrl) => {
    try {
      ...
      2. A photo of a clothing product (Product Image).
      
      Your task: Generate a highly realistic image of the person from the first image wearing the product from the second image.
      
      CRITICAL REQUIREMENTS:
      - PRESERVE PRODUCT DETAILS: The clothing item must look EXACTLY like the Product Image. Maintain all textures, patterns, logos, buttons, zippers, collar shape, and color shades. Do not hallucinate or alter the design of the clothing.
      - NATURAL FIT: Adapt the clothing to the person's body shape and pose naturally, including realistic folds and lighting interactions.
      - PRESERVE PERSON: Maintain the person's identity, pose, facial features, and skin tone exactly as they are in the User Image.
      - HIGH QUALITY: The output must be photorealistic and high resolution.
