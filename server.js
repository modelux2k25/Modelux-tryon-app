...
const generateVirtualTryOn = async (userImageBuffer, userMimeType, productImageUrl) => {
    try {
      ...
      INPUTS:
      1. User Image: A photo of a person.
      2. Product Image: A photo of a clothing item.
      
      TASK:
      Generate a photorealistic image of the person from the User Image wearing the clothing from the Product Image.
      
      STRICT CONSTRAINTS (MUST FOLLOW):
      1. **PRODUCT FIDELITY IS PARAMOUNT**: The clothing in the output MUST look identical to the Product Image. 
         - You MUST preserve the exact texture, fabric pattern, logos, text, buttons, zippers, and color shades.
         - Do NOT hallucinate new patterns or change the style.
         - If the product has a logo, it must be clearly visible and unchanged.
      2. **REALISTIC FIT**: Warp the clothing to fit the person's body pose naturally. Add realistic lighting and shadows that match the User Image.
      3. **PRESERVE PERSON**: Do not change the person's face, hair, body shape, or skin tone.
