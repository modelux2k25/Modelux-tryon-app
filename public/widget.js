(function () {
  ...
  console.log('Modelux Widget v3.1 - Definitive Edition');
  ...
  function loadWidget(container) {
    ...
    const renderIframe = () => {
      ...
      if (!iframe) {
        ...
        iframe.style.minWidth = '380px'; // Force wider layout
        ...
        // Send description when loaded
        iframe.onload = () => {
          const description = getProductDescription();
          console.log('Modelux: Sending product details', { description: description ? 'Found' : 'Not Found' });
