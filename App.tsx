            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white p-3 rounded-2xl shadow-md border border-slate-100 relative group">
                ...
                <div className="aspect-[3/4] rounded-xl bg-slate-100 overflow-hidden relative border border-slate-200">
                  ...
                  <button onClick={triggerSelectionMode} className="absolute top-2 right-2 p-2 bg-white/80 hover:bg-indigo-600 rounded-full shadow-sm transition-colors"><Sparkles className="w-4 h-4 text-indigo-600" /></button>
                </div>
              </div>
