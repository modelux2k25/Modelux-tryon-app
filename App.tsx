        ...
        {step === Step.RESULT && resultImage && (
          <div className="flex flex-col h-full animate-fade-in">
            ...
            <div className="mt-6 flex flex-col gap-3">
              <button onClick={handleGenerate} className="w-full py-4 rounded-xl font-bold text-white bg-indigo-600 hover:bg-indigo-700 shadow-lg transition-all flex items-center justify-center gap-2">
