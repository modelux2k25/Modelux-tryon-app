        ...
        {step === Step.CHOICE && (
          <div className="space-y-6 animate-fade-in">
            ...
            <button
              ...
              className="w-full py-4 rounded-xl font-bold text-lg shadow-lg flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white disabled:bg-slate-300 disabled:from-slate-300 disabled:to-slate-300 disabled:text-slate-400"
            >
              {isLoading ? (
        ...
        {step === Step.SIZE_RESULT && (
          <div className="space-y-6 animate-fade-in flex flex-col items-center justify-center h-full pt-10">
            ...
            <div className="w-full pt-8 space-y-3">
              ...
              <button onClick={() => setStep(Step.MEASUREMENTS)} className="w-full py-3 bg-white border border-slate-200 text-slate-500 font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-slate-50">
        ...
        {step === Step.RESULT && resultImage && (
          <div className="h-full flex flex-col animate-fade-in relative">
            <div className="flex items-center justify-between pb-2 shrink-0">
              <h2 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">Resultado</h2>
              <button onClick={() => setStep(Step.HOME)} className="p-1.5 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors"><X className="w-4 h-4 text-slate-600" /></button>
            </div>
            ...
            <div className="pt-3 shrink-0 space-y-2">
              <button onClick={() => setStep(Step.CHOICE)} className="w-full py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl flex items-center justify-center gap-2 shadow-md transition-colors text-sm"><RotateCcw className="w-4 h-4" /> Tentar Outra Peça</button>
              <div className="text-center text-[10px] text-slate-400">Tentativas: <strong className="text-indigo-600">{usageCount}</strong>/{MAX_WEEKLY_USAGE} (Semana)</div>
            </div>
          </div>
        )}
